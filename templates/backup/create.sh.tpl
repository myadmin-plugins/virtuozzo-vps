...
{/if}
function iprogress() {
  curl --connect-timeout 60 --max-time 240 -k -d action=install_progress -d progress=$1 -d server={$vps_id} 'https://myvps.interserver.net/vps_queue.php' < /dev/null > /dev/null 2>&1;
}
IFS="
"
webuzo=0
